...
export default async function OverviewPage() {
  ...
  const [
    ...
    prisma.template.count({
      where: { organizationId, parentId: null, marketplaceStatus: null, isBlogLayout: false, publishedDomains: { some: {} } },
    }),
    ...
    prisma.template.count({
      where: { organizationId, parentId: null, marketplaceStatus: null, isBlogLayout: false, publishedDomains: { none: {} } },
    }),
