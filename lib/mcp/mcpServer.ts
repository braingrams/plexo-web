...
export const PLEXO_MCP_TOOLS = [
  {
    ...
    description:
      "Creates, compiles, and publishes a landing page template to a subdomain or custom domain in 1 step. Expects designJson generated by the AI matching the Plexo layout schema.",
    inputSchema: {
      type: "object",
      properties: {
        name: {
        ...
        designJson: {
          type: "object",
          description: "Plexo layout schema object generated by the AI containing body style and rows array.",
          required: ["body"],
          properties: {
            body: {
              type: "object",
                              ...
                              items: {
                                ...
                                properties: {
                                  type: {
                                    ...
                                    description: "Type of component element.",
                                  },
                                  style: { type: "object" },
                                  attributes: { type: "object", description: "Attributes like text, href, src, title, description, links, fields." },
                                },
                              },
                            },
                          },
